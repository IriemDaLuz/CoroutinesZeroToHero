...
interface ApiServices {
    @GET("/api/03a71467618d0031ce23ec78c09b26c2/search/{name}")
...
data class Connections(
    @SerializedName("group-affiliation") val groupAffiliation: List<String>,
    @SerializedName("relatives") val relatives: List<String>
)
